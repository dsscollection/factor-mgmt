...
OUR RESPONSE: Please note that we're now running the development version of dplyr that has the fix for the problem with case_when. We added spaces around all double equals in the paper. 
