...
famIncome <- GSS$OpinionOfIncome
summary(famIncome)
levels(famIncome) <- c("Far above average", "Above average", "Average", "Below Average", 
  "Far below average", "Don't know", "No answer")
summary(famIncome)
@
XX NH I don't know if we should include this because it is so bad. 
...
levels(GSS$BaseOpinionOfIncome) <- 
  levels(GSS$BaseOpinionOfIncome)[c(5,1:3,6,4,7)]
summary(GSS$BaseOpinionOfIncome)
@
